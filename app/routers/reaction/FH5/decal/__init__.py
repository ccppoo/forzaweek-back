...
from .decal_image import router as decalImageRouter


# router.include_router(decalImageRouter, prefix="/image")
...
@router.get("/{decal_id}/image/{decal_image_id}/vote")
...
@router.put("/{decal_id}/image/{decal_image_id}/vote/{vote_side}")
